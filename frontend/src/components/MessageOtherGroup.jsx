      ...
      >
        ...
        {hasMedia && (
          <div className="flex flex-col items-start gap-2">
            ...
            {/* Audio */}
            {hasAudio && (
              <div className="rounded-lg p-2 w-[85vw] max-w-[220px] min-w-[100px] flex flex-col items-center bg-transparent mx-auto">
            ...
            {hasFile && (
              <div
                className={`flex items-center gap-2 p-2 rounded-lg cursor-pointer transition-colors duration-200 w-full max-w-[300px] sm:w-[300px] ${
